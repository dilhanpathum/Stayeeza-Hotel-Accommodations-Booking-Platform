...
//    $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    //Optional name
    ...
    if($user->checkUser($email)){
    $mail->Body    = 'You can reset your password.click <b><a href="localhost/Project-1/resetPassword.php?userId='.$id.'">Reset Password</a></b>';
    }
    if($user->checkowner($email)){
    $mail->Body    = 'You can reset your password.click <b><a href="localhost/Project-1/resetPassword.php?ownerId='.$id.'">Reset Password</a></b>';
    }
