                ...
                <div id="content" style="color: #2D2F3E;">
                    <div class="container-fluid" style="margin-bottom: 50px;">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 text-end" style="margin-bottom: 30px;"><a href="adminpanel-user.php"
                                                                                                           class="btn btn-primary" role="button"><i class="fa fa-plus"></i>&nbsp;View Users</a></div>
                        </div>
...
foreach ($rs as $users) {
    ?>
                                                    ...
                                                    <tr style="background: #262a38;">
                                                        <td style="color: rgb(0,0,0);"><?php echo $users["ownerId"]; ?></td>
                                                        <td style="color: rgb(0,0,0);"><?php echo $users["ownerEmail"]; ?></td>
                                                        <td style="color: rgb(0,0,0);">Yes</td>
                                                        <td class="text-center align-middle"
                                                            style="max-height: 60px;height: 60px;"><a class="btn btnMaterial btn-flat primary semicircle" role="button" href="user.php?viewHOwner=<?php echo $users["ownerId"]; ?>" style="color: #00bdff;"><i class="far fa-eye"></i></a>
                                                            <a  class="btn btnMaterial btn-flat primary semicircle" role="button" href="adminpanel-owner.php?delete=<?php echo $users["ownerId"]; ?>" style="color: #DC3545;"><i class="fas fa-trash btnNoBorders"></i></a>
                                                            </td>
                                                    </tr>
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                               <?php
                                ...
                                $deleteuser->deleteHOwner($id);
                               ?>
                                window.location.href="adminpanel-owner.php?success=1";
                            }
                        })
