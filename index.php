...
<body style="background: url(&quot;assets/img/download.png&quot;), #fff9e4;">
    ...
    <section class="py-4 py-xl-5 .header-container.back"
        style="background: url(&quot;assets/img/background.jpg&quot;) center / cover no-repeat;">
                ...
                <div
                    ...
                    <div class="heading">
                        ...
                        <p class="mb-4">Discover the Art of Hospitality: Your Premier Destination for Unforgettable
                            Hotel Experiences and Seamless Accommodation Bookings.</p><button
                            class="btn btn-primary fs-5 me-2 py-2 px-4 btn-book" type="button"
                            style="font-weight: bold;">Booking Now</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container px-5" style="background: #343a40;margin-top: 16px;">
        <div class="row gy-4 gy-md-0">
            <div class="col-md-6 align-items-center justify-content-center d-flex">
                <div class="m-xl-5" style="border-radius: 6px;"><img class="rounded img-fluid w-100 fit-cover"
                        style="min-height: 300px;border-radius: 34px;" src="assets/img/1.gif"></div>
            </div>
            <div class="col-md-6 col-xl-6 d-md-flex align-items-md-center">
                <div style="/*max-width: 350px;*/">
                    <h2 class="text-uppercase fw-bold"
                        style="font-family: Actor, sans-serif;color: rgb(255,255,255);text-align: center;">Your Ultimate
                    ...
                    <p class="my-3 mt-3" style="color: rgb(255,255,255);">Your One-Stop Destination for Effortless Hotel
                        ...
                        Convenience at the Heart of Every Stay. </p><a
                        class="btn btn-primary btn-lg me-3 col-12 mt-3" role="button" href="#"
                        style="font-weight: bold;">Book Your Room&nbsp;<i
                        class="fas fa-light fas fa-bed fab fa-spin"></i></a>
                ...
                <div class="row1" data-masonry="{&quot;percentPosition&quot;: true }">
                    <div class="col-xs-10 col-sm-6 col-lg-4 col-xl-3 mb-4">
                        <div class="card"
                            ...
                            <picture type="" srcset=""><img class="card-img-top p-3" src="assets/img/1.jpg" alt=""
                                    style="border-radius: 24px;object-fit: cover;padding-bottom: 5px;margin-bottom: -11px;"
                                    width="286" height="286"></picture>
                            <div class="card-body" style="padding-top: 0px;padding-bottom: 16px;text-align: center;">
                                <h5 class="card-title" style="margin-bottom: 0px;color: rgb(255,255,255);">Grand Riviera
                                    Resort</h5>
                                <p class="card-text" style="margin-bottom: 0px;color: rgb(108, 117, 125);">Miami Beach,
                                    Florida</p>
                                <div class="btn-group" role="group" style="padding-top: 6px;border-style: none;"><button
                                        class="btn btn-primary btn-d" type="button"
                                        style="border-radius: 56px;width: 156.325px;"><strong>Book
                                            Now</strong>&nbsp;<svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="col-xs-10 col-sm-6 col-lg-4 col-xl-3 mb-4">
                        <div class="card"
                            style="background: rgb(33,37,41);border-style: none;box-shadow: 0px 0px 15px 3px #ffffff08;">
                            <picture type="" srcset=""><img class="card-img-top p-3" src="assets/img/2-1.jpg" alt=""
                                    style="border-radius: 24px;object-fit: cover;padding-bottom: 5px;margin-bottom: -11px;"
                                    width="286" height="286"></picture>
                            <div class="card-body" style="padding-top: 0px;padding-bottom: 16px;text-align: center;">
                                <h5 class="card-title" style="margin-bottom: 0px;color: rgb(255,255,255);">Serenity
                                    Heights Lodge</h5>
                                <p class="card-text" style="margin-bottom: 0px;color: rgb(108, 117, 125);">Aspen,
                                    Colorado</p>
                                <div class="btn-group" role="group" style="padding-top: 6px;border-style: none;"><button
                                        class="btn btn-primary btn-d" type="button"
                                        style="border-radius: 56px;width: 156.325px;"><strong>Book
                    ...
                    <div class="col-xs-10 col-sm-6 col-lg-4 col-xl-3 mb-4">
                        <div class="card"
                            style="background: rgb(33,37,41);border-style: none;box-shadow: 0px 0px 15px 3px #ffffff08;">
                            <picture type="" srcset=""><img class="card-img-top p-3" src="assets/img/3-2.jpg" alt=""
                                    style="border-radius: 24px;object-fit: cover;padding-bottom: 5px;margin-bottom: -11px;"
                                    width="286" height="286"></picture>
                            <div class="card-body" style="padding-top: 0px;padding-bottom: 16px;text-align: center;">
                                <h5 class="card-title" style="margin-bottom: 0px;color: rgb(255,255,255);">Tranquil
                                    Oasis Resort</h5>
                                <p class="card-text" style="margin-bottom: 0px;color: rgb(108, 117, 125);">New York
                                    City, USA</p>
                                <div class="btn-group" role="group" style="padding-top: 6px;border-style: none;"><button
                                        class="btn btn-primary btn-d" type="button"
                                        style="border-radius: 56px;width: 156.325px;"><strong>Book
                    ...
                    <div class="col-xs-10 col-sm-6 col-lg-4 col-xl-3 mb-4">
                        <div class="card"
                            style="background: rgb(33,37,41);border-style: none;box-shadow: 0px 0px 15px 3px #ffffff08;">
                            <picture type="" srcset=""><img class="card-img-top p-3" src="assets/img/4.jpg" alt=""
                                    style="border-radius: 24px;object-fit: cover;padding-bottom: 5px;margin-bottom: -11px;"
                                    width="286" height="286"></picture>
                            <div class="card-body" style="padding-top: 0px;padding-bottom: 16px;text-align: center;">
                                <h5 class="card-title" style="margin-bottom: 0px;color: rgb(255,255,255);">Coastal Haven
                                    Hotel</h5>
                                <p class="card-text" style="margin-bottom: 0px;color: rgb(108, 117, 125);">London,
                                    United Kingdom</p>
                                <div class="btn-group" role="group" style="padding-top: 6px;border-style: none;"><button
                                        class="btn btn-primary btn-d" type="button"
                                        style="border-radius: 56px;width: 156.325px;"><strong>Book
                    ...
                    <div class="col-xs-10 col-sm-6 col-lg-4 col-xl-3 mb-4">
                        <div class="card"
                            style="background: rgb(33,37,41);border-style: none;box-shadow: 0px 0px 15px 3px #ffffff08;">
                            <picture type="" srcset=""><img class="card-img-top p-3" src="assets/img/5.jpg" alt=""
                                    style="border-radius: 24px;object-fit: cover;padding-bottom: 5px;margin-bottom: -11px;"
                                    width="286" height="286"></picture>
                            <div class="card-body" style="padding-top: 0px;padding-bottom: 16px;text-align: center;">
                                <h5 class="card-title" style="margin-bottom: 0px;color: rgb(255,255,255);">Royal Garden
                                    Retreat</h5>
                                <p class="card-text" style="margin-bottom: 0px;color: rgb(108, 117, 125);">Zermatt,
                                    Switzerland</p>
                                <div class="btn-group" role="group" style="padding-top: 6px;border-style: none;"><button
                                        class="btn btn-primary btn-d" type="button"
                                        style="border-radius: 56px;width: 156.325px;"><strong>Book
                    ...
                    <div class="col-xs-10 col-sm-6 col-lg-4 col-xl-3 mb-4">
                        <div class="card"
                            style="background: rgb(33,37,41);border-style: none;box-shadow: 0px 0px 15px 3px #ffffff08;">
                            <picture type="" srcset=""><img class="card-img-top p-3" src="assets/img/6.jpg" alt=""
                                    style="border-radius: 24px;object-fit: cover;padding-bottom: 5px;margin-bottom: -11px;"
                                    width="286" height="286"></picture>
                            <div class="card-body" style="padding-top: 0px;padding-bottom: 16px;text-align: center;">
                                <h5 class="card-title" style="margin-bottom: 0px;color: rgb(255,255,255);">Oceanview
                                    Paradise Hotel</h5>
                                <p class="card-text" style="margin-bottom: 0px;color: rgb(108, 117, 125);">Maldives</p>
                                <div class="btn-group" role="group" style="padding-top: 6px;border-style: none;"><button
                                        class="btn btn-primary btn-d" type="button"
                                        style="border-radius: 56px;width: 156.325px;"><strong>Book
                                            Now</strong>&nbsp;<svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="col-xs-10 col-sm-6 col-lg-4 col-xl-3 mb-4">
                        <div class="card"
                            style="background: rgb(33,37,41);border-style: none;box-shadow: 0px 0px 15px 3px #ffffff08;">
                            <picture type="" srcset=""><img class="card-img-top p-3" src="assets/img/7.jpg" alt=""
                                    style="border-radius: 24px;object-fit: cover;padding-bottom: 5px;margin-bottom: -11px;"
                                    width="286" height="286"></picture>
                            <div class="card-body" style="padding-top: 0px;padding-bottom: 16px;text-align: center;">
                                <h5 class="card-title" style="margin-bottom: 0px;color: rgb(255,255,255);">Cityscape
                                    Plaza Hotel</h5>
                                <p class="card-text" style="margin-bottom: 0px;color: rgb(108, 117, 125);">Cancun,
                                    Mexico</p>
                                <div class="btn-group" role="group" style="padding-top: 6px;border-style: none;"><button
                                        class="btn btn-primary btn-d" type="button"
                                        style="border-radius: 56px;width: 156.325px;"><strong>Book
                    ...
                    <div class="col-xs-10 col-sm-6 col-lg-4 col-xl-3 mb-4">
                        <div class="card"
                            style="background: rgb(33,37,41);border-style: none;box-shadow: 0px 0px 15px 3px #ffffff08;">
                            <picture type="" srcset=""><img class="card-img-top p-3"
                                    src="assets/img/umbrella-armchairs.jpg" alt=""
                                    style="border-radius: 24px;object-fit: cover;padding-bottom: 5px;margin-bottom: -11px;"
                                    width="286" height="286"></picture>
                            <div class="card-body" style="padding-top: 0px;padding-bottom: 16px;text-align: center;">
                                <h5 class="card-title" style="margin-bottom: 0px;color: rgb(255,255,255);">Sunset Sands
                                    Resort</h5>
                                <p class="card-text" style="margin-bottom: 0px;color: rgb(108, 117, 125);">Banff, Canada
                                </p>
                                <div class="btn-group" role="group" style="padding-top: 6px;border-style: none;"><button
                                        class="btn btn-primary btn-d" type="button"
                                        style="border-radius: 56px;width: 156.325px;"><strong>Book
                ...
                <div class="card"><img class="card-img-top w-100 d-block fit-cover" style="height: 200px;"
                    ...
                    <div class="card-body p-4" style="height: 390.8px;">
                        <p class="text-primary card-text mb-0"><i class="fab fas fa-star fa-spin" style="color: #ffd700;"></i>
                            ...
                            <i class="fab fas fa-star fa-spin" style="color: #ffd700;"></i>
                            <i class="fab fas fa-star fa-spin" style="color: #ffd700;"></i>
                            <i class="fab fas fa-star fa-spin" style="color: #ffd700;"></i></p>
                        ...
                        <div class="d-flex"><img class="rounded-circle flex-shrink-0 me-3 fit-cover" width="50"
                                height="50" src="assets/img/p2.jpg">
                            <div>
            ...
            <div class="col">
                <div class="card"><img class="card-img-top w-100 d-block fit-cover" style="height: 200px;"
                    ...
                    <div class="card-body p-4" style="height: 389.8px;">
                        ...
                        <div class="d-flex"><img class="rounded-circle flex-shrink-0 me-3 fit-cover" width="50"
                                height="50" src="assets/img/p1.jpg">
                            <div>
                ...
                <div class="card"><img class="card-img-top w-100 d-block fit-cover" style="height: 200px;"
                    ...
                    <div class="card-body p-4" style="height: 390.8px;">
                        ...
                        <p class="card-text">"I had an amazing stay at Serene Haven Resort! The staff was incredibly
                            ...
                            getaway!"</p>
                        <div class="d-flex"><img class="rounded-circle flex-shrink-0 me-3 fit-cover" width="50"
                                height="50" src="assets/img/p3.jpg">
                            <div>
    ...
    <div class="container py-4 py-xl-5" style="background: #343a40;">
        <div class="row gy-4 gy-md-0">
            <div class="col-md-6">
                <div class="p-xl-2 m-xl-2"><img class="rounded img-fluid w-100 fit-cover"
                        style="min-height: 300px;padding-right: 0px;" src="assets/img/aerial-view-pool.jpg" width="444"
                        height="300"></div>
            </div>
            <div class="col-md-6 col-xxl-6 offset-xxl-0 d-md-flex align-items-md-center">
                <div style="width: 505px;">
                    <h2 class="text-uppercase fw-bold text-primary"
                        style="font-family: 'Autour One', serif;text-align: center;">Expand Your Reach: Showcase Your
                    ...
                    <p class="my-3" style="color: rgb(252,252,252);text-align: justify;">Promote your hotel to millions
                        ...
                        our network and unlock a world of opportunities for your property</p><a
                        class="btn btn-primary btn-lg me-3 col-12 mt-3" role="button" href="#"
                        style="font-weight: bold;">Add Hotel</a>
                </div>
            </div>
        </div>
    </div>
