    ...
    <nav class="navbar navbar-light navbar-expand-md py-3"
        ...
        <div class="container"><img src="assets/img/logo-color%20(1).png" width="85" height="45"
            ...
            <div class="collapse navbar-collapse" id="navcol-1"
                ...
                </ul><button class="btn btn-primary" type="button" style="margin-right: 20px;">LOG IN</button><button
    ...
    <div class="row gy-4 row-cols-1 row-cols-md-2">
        <div class="col">
            <div class="d-flex flex-column flex-lg-row">
                <div class="w-100"><img class="rounded img-fluid d-block w-100 fit-cover" style="height: 200px;" src="https://media.istockphoto.com/id/119926339/photo/resort-swimming-pool.jpg?s=612x612&w=0&k=20&c=9QtwJC2boq3GFHaeDsKytF4-CavYKQuy1jBD2IRfYKc=" /></div>
